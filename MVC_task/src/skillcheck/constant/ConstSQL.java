...
public final class ConstSQL {
    ...
    /** パスワード */
    public static final String JDBC_POSTGRES_PASS = "1126";
    ...
    public static final String SELECT_BASE = "SELECT * FROM Employee WHERE empid and password and name and mail and programingLanguage and comment";
